...
export function ReviewFunnel({ profile }: { profile: ReviewProfile }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-[480px] mx-auto px-6 pt-16 pb-20 text-center">
        ...
        {step === 'ask' && (
          <div className="animate-[fadeUp_0.5s_ease]">
            <h1 className="text-3xl font-semibold text-gray-900 mb-3 leading-snug text-balance">
              {profile.heading}
            </h1>
      ...
      {/* Footer */}
      <div className="fixed bottom-0 left-0 right-0 text-center py-3 bg-gradient-to-t from-white via-white to-transparent">
